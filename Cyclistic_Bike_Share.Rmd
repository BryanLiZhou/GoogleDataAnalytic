...
Now, it is time to fill in NA of start station id, end station id with their respective station names  using the fill() function.  Filter out any columns that can not be used to match the values.
...
### Recommendation
     ...
     * Ask riders to take survey to gain more insight into their preferences.
     * Use marketing ads to target casual riders during the weekends and summers.
     * Create a promotional video and host it on youtube, other afflilate sites, and social media.